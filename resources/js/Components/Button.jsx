...
// React functional component dengan beberapa props
export default function Button({ type, url, className, children, ...props }) {

    // menggunakkan form helper yang disediakan inertia
    const { delete : destroy } = useForm();

    // Membuat method baru handleDeleteData
    // tambahkan paramenter url yang diambil dari props url
    const handleDeleteData = async (url) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // didalam method menggunakkan SweetAlert 
                // untuk menampilkan jendela konfirmasi sebelum data dihapus
                Swal.fire({
                    title: 'Success!',
