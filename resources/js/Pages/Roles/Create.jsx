...
export default function Create({ auth }) {
    ...
    // untuk menangkap sebuah value dari component checkbox
    ...
    // untuk mengirimkan data ke server menggunakkan form helper inertia
    const handleStoreData = async (e) => {
        e.preventDefault();


        // arahkan ke sebuah route (roles.store)
        // jika data berhasil sweetalert muncul
