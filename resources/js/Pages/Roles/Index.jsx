...
// react function component props auth
export default function Index({ auth }) {
    // destruct permissions props
    const { roles ,filters} = usePage().props;

    // Memanggil utils hasAnyPermissions
    // mengecek user memiliki hak akses untuk menambah data roles
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
